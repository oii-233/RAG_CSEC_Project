...
const generateAIResponse = async (
    ...
    try {
        ...
        const model = genAI.getGenerativeModel({ 
            model: GEMINI_MODEL,
            systemInstruction: {
                parts: [{ text: `You are ዘብ AI, the intelligent safety assistant for the ASTU (Adama Science and Technology University) Smart Campus Safety Platform. 
...
5. If the context doesn't have the answer, gracefully direct the user to campus security.` }]
        ...
        // System prompt for ዘብ AI assistant - optimized for Gemini 2.5 Flash
