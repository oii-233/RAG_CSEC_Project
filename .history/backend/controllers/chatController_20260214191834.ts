...
export const askQuestion = async (req: IAuthRequest, res: Response): Promise<void> => {
    try {
        ...
        try {
            ...
            console.error('⚠️ RAG Service Failed to process question:', error);
            answer = "I apologize, but I am unable to connect to the AI service right now. Please try again later.";
            relevantDocs = [];
        }
